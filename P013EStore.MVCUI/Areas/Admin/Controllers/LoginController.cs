        ...
        public async Task<IActionResult> IndexAsync(AdminLoginViewModel admin)
        {
            try
            {
                ...
                if (kullanici != null)
                {
                    ...
                    await HttpContext.SignInAsync(principal); //HttpContext .net içerisinden geliyor uygulamanın çalışma anındaki içeriğe ulaşmamızı sağlıyor. SignInAsync metodu da .net içerisinde mevcut login işlemi yapmak istersek burdaki gibi kullanıyoruz.
